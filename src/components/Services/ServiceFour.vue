            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="single-service service-gallery overflow-hidden">
                        <!-- Service Thumb -->
                        <div class="service-thumb">
                            <a href="#"><img src="assets/img/case_studies_4.jpg" alt=""></a>
                        </div>
                        <!-- Service Content -->
                        <div class="service-content bg-white">
                            <a href="#">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="single-service service-gallery overflow-hidden">
                        <!-- Service Thumb -->
                        <div class="service-thumb">
                            <a href="#"><img src="assets/img/case_studies_5.jpg" alt=""></a>
                        </div>
                        <!-- Service Content -->
                        <div class="service-content bg-white">
                            <a href="#">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="single-service service-gallery overflow-hidden">
                        <!-- Service Thumb -->
                        <div class="service-thumb">
                            <a href="#"><img src="assets/img/case_studies_6.jpg" alt=""></a>
                        </div>
                        <!-- Service Content -->
                        <div class="service-content bg-white">
                            <a href="#">
